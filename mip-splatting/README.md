...
**Memory & Speed improvements for RTX 5060 Ti 16GB:**
- **VRAM:** Peak eval reduced 51% (15.6GB → 8.0GB) via `torch.no_grad()` fix
- **Speed:** Training +3.3% faster (11.06 → 11.42 it/s) via register spilling + evaluation fixes
- **Quality:** No degradation (PSNR: 26.01dB, SSIM: 0.789, LPIPS: 0.241)
- **Total VRAM saved:** 12.2GB (histogram downsampling, GT caching, eval autograd fix)
- **Details:** See [DOCS/MIPS_OPTIMISATION.MD](../DOCS/MIPS_OPTIMISATION.MD) and [DOCS/MIPS_SUMMARY.MD](../DOCS/MIPS_SUMMARY.MD) 
